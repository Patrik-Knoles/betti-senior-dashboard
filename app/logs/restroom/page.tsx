    ...
    <div className="min-h-screen bg-white p-4 font-sans">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {isMenuOpen && (
          ...
          >
            <div
              className="fixed right-0 top-0 h-full w-full sm:w-80 bg-white shadow-lg p-6 overflow-y-auto"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          <Card className="bg-white border-gray-200 shadow-lg">
            <CardContent className="p-4 text-center sm:text-left">
              ...
              <div className="text-sm text-gray-600">Avg Daily Visits</div>
            </CardContent>
          </Card>
          <Card className="bg-white border-gray-200 shadow-lg">
            <CardContent className="p-4 text-center sm:text-left">
          ...
          <Card className="bg-white border-gray-200 shadow-lg">
            <CardContent className="p-4 text-center sm:text-left">
              <div className="flex justify-center sm:justify-start items-center gap-2">
                <TrendingUp className="h-5 w-5 text-[#5C7F39]" />
                <Badge className="bg-[#5C7F39] text-white">
          ...
          <CardContent>
            <div className="space-y-3">
              {filteredLogs.map((log) => (
                <div
                  key={log.id}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-gray-100 rounded-lg"
                >
